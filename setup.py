"""setup.py file for the ``split_into_folders`` package.
"""
import fnmatch
import os
import sys
...
from split_into_folders import __version__, __test_version__

if sys.version_info < (3, 7):
    raise RuntimeError("""
    split_into_folders v0.1.0+ supports Python 3.7 and above. 
    """)
...
setup(name='split-ebooks-into-folders',
      ...
      keywords='calibre djvu ebook epub pdf script',
      url='https://github.com/raul23/split-ebooks-into-folders',
      author='Raul C.',
      ...
      entry_points={
        'console_scripts': ['split_into_folders=split_into_folders.scripts.split_into_folders:main']
      },
      project_urls={  # Optional
          'Bug Reports': 'https://github.com/raul23/split-ebooks-into-folders/issues',
          'Source': 'https://github.com/raul23/split-ebooks-into-folders',
      },
      zip_safe=False)
